...
### Accent Font Budget (v6.1)

`--font-accent` (Caveat or similar script/italic) has a hard usage budget: **~5 uses on the homepage, 1 per inner page** (the section subtitle). Exceeding the budget reads as gimmicky, not premium. The design-critic and QA passes flag overuse as a hard failure.
